...
void hgp_vrr_2_1_(
    ...
    a2b1[ 3] = QCz * a2b0[ 1] + WQz * a2b0[ 7] + 0.5 * 1 * invZeta * a1b0[ 4];
    ...
    a2b1[ 9] = PAz * a1b1[ 6] + WPz * a1b1[15] + 0.5 * 1 * invZeta * a1b0[ 5];
    a2b1[10] = PAx * a1b1[ 1] + WPx * a1b1[10];
    a2b1[11] = QCx * a2b0[ 3] + WQx * a2b0[ 9] + 0.5 * 1 * invZeta * a1b0[ 3];
    a2b1[12] = PAy * a1b1[ 6] + WPy * a1b1[15];
    a2b1[13] = QCy * a2b0[ 4] + WQy * a2b0[10] + 0.5 * 1 * invZeta * a1b0[ 5];
    a2b1[14] = QCx * a2b0[ 4] + WQx * a2b0[10] + 0.5 * 1 * invZeta * a1b0[ 4];
